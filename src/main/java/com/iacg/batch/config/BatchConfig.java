...
import com.iacg.batch.steps.JobCompletionNotificationListener;
import com.iacg.batch.steps.PersonItemProcessor;
import com.iacg.batch.steps.PersonItemReader;
import com.iacg.batch.steps.PersonItemWriter;
...
public class BatchConfig {
	...
	Step readFilePersonStep() {
		return stepBuilderFactory.get("readFilePersonStep")
				.<PersonModel, PersonModel>chunk(50)
